...
def prepare_dataloader(img_dir, mask_dir, anno_dir, anno_keys, val_names,
                       mask_classes, batch_size, target_size, aug, only_ncaam):
    '''
    ...
    train = BasicDataset(train_ids, img_dir, mask_dir, anno_dir, anno_keys, mask_classes, target_size, aug=aug)
    val = BasicDataset(val_ids, img_dir, mask_dir, anno_dir, anno_keys, mask_classes, target_size)
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                if global_step % val_step_n == 0:
                    ...
                    val_tot_score = val_ce_score + val_rec_score + val_reproj_score + val_consist_score
